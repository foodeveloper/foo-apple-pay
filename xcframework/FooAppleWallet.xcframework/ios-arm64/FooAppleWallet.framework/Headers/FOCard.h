...
- (instancetype)initWithIdentifier:(NSString *)identifier cardTitle:(NSString *)title cardArt:(UIImage *)cardArt cardholderName:(NSString *)cardholderName panSuffix:(NSString *)panSuffix pan:(nullable NSString *)pan expiryDate:(nullable NSString *)expiryDate;
